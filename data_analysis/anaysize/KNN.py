...
# file = "/Users/chandler/Documents/Projects/machine-learning/data_analysis/anaysize/trainingfile/3_9.txt"
...
def handwriting_guess():
    ...
    for i in range(testfile_nums):
        ...
        if knn_result != test_digit:
            error_count += 1.0
    print("\nthe 识别出错数量: %d" % error_count)
    print("\nthe 识别错误率: %f" % (error_count / float(testfile_nums)))
# 运行KNN算法识别手写数字
handwriting_guess()
